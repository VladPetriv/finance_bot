...
func (_m *OperationStore) GetAll(ctx context.Context) ([]models.Operation, error) {
	ret := _m.Called(ctx)
	...
	if rf, ok := ret.Get(0).(func(context.Context) []models.Operation); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
...
type mockConstructorTestingTNewOperationStore interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewOperationStore(t mockConstructorTestingTNewOperationStore) *OperationStore {
	mock := &OperationStore{}
	mock.Mock.Test(t)
